...
from dataset.preprocess.jukebox.hparams import Hyperparams
from dataset.preprocess.jukebox.data.labels import EmptyLabeller
from dataset.preprocess.jukebox.utils.torch_utils import empty_cache
from dataset.preprocess.jukebox.utils.audio_utils import save_wav, load_audio
from dataset.preprocess.jukebox.make_models import make_model
from dataset.preprocess.jukebox.align import get_alignment
from dataset.preprocess.jukebox.save_html import save_html
from dataset.preprocess.jukebox.utils.sample_utils import split_batch, get_starts
from dataset.preprocess.jukebox.utils.dist_utils import print_once
import fire
...
def save_samples(model, device, hps, sample_hps):
    print(hps)
    from dataset.preprocess.jukebox.lyricdict import poems, gpt_2_lyrics
