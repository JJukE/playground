...
def make_vqvae(hps, device='cuda'):
    from dataset.preprocess.jukebox.vqvae.vqvae import VQVAE
...
def make_prior(hps, vqvae, device='cuda'):
    from dataset.preprocess.jukebox.prior.prior import SimplePrior
    ...
    if hps.fp16_params:
        ...
        from dataset.preprocess.jukebox.transformer.ops import _convert_conv_weights_to_fp16
