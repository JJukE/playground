...
from dataset.preprocess.jukebox.transformer.ops import LayerNorm
from dataset.preprocess.jukebox.prior.autoregressive import ConditionalAutoregressive2D
from dataset.preprocess.jukebox.prior.conditioners import Conditioner, LabelConditioner
from dataset.preprocess.jukebox.data.labels import EmptyLabeller, Labeller

from dataset.preprocess.jukebox.utils.torch_utils import assert_shape
from dataset.preprocess.jukebox.utils.dist_utils import print_once
from dataset.preprocess.jukebox.vqvae.vqvae import calculate_strides
    ...
    def __init__(self, z_shapes, l_bins, encoder, decoder, level,
        ...
        if single_enc_dec:
            ...
            if self.n_tokens != 0 and self.use_tokens:
                from dataset.preprocess.jukebox.transformer.ops import Conv1D
