...
class SS2DBlockv3:
    def __initxv__(
        ...
        **kwargs,
        ...
        # tags for forward_type ==============================
        checkpostfix = SS2DBlockv2.checkpostfix
        self.out_norm, forward_type = SS2DBlockv2.get_outnorm(forward_type, d_inner, channel_first)
...
class SS2DBlockm0:
    def __initm0__(
        ...
        **kwargs,    
        ...
        self.disable_z, forward_type = checkpostfix("_noz", forward_type)
        self.disable_z_act, forward_type = checkpostfix("_nozact", forward_type)
        self.out_norm, forward_type = SS2DBlockv2.get_outnorm(forward_type, d_inner, False)
...
class SS2DBlock(nn.Module, SS2DBlockv0, SS2DBlockv2, SS2DBlockv3, SS2DBlockm0):
    def __init__(
        self,
        # basic dims ===========
        d_model=96,
